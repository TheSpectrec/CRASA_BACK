...
public class Peso extends BaseEntity {
    ...
    private BigDecimal valor; // Dinero total gastado
    private int mes;
    private int año;
    ...
    private String tipoReporte; // "REP PESOS", "REP GENERAL"
    ...
    public Peso(Customer cliente, Product producto, Family familia, Mark marca, 
                BigDecimal valor, int mes, int año, LocalDateTime fecha, 
